...
CREATE TABLE IF NOT EXISTS `civilife`.`result` (
  ...
  `player_id` INT NOT NULL,
  `resultBoard_result_id` INT NOT NULL,
  `resultBoard_user_id` INT NOT NULL,
  PRIMARY KEY (`result_id`),
  INDEX `fk_result_player1_idx` (`player_id` ASC) VISIBLE,
  INDEX `fk_result_resultBoard1_idx` (`resultBoard_result_id` ASC, `resultBoard_user_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_result_resultBoard1`
    FOREIGN KEY (`resultBoard_result_id` , `resultBoard_user_id`)
