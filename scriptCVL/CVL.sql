...
CREATE TABLE IF NOT EXISTS `civilife`.`MENU` (
  ...
  `timeId` INT NOT NULL,
  PRIMARY KEY (`menu_id`),
  INDEX `fk_MENU_RESTAURANT1_idx` (`resId` ASC) VISIBLE,
  INDEX `fk_MENU_TIME1_idx` (`timeId` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `civilife`.`CHARACTER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `civilife`.`CHARACTER` (
  `cha_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `civilife`.`PLAYER` (
  ...
  CONSTRAINT `fk_Player_CHARACTER1`
    FOREIGN KEY (`cha_id`)
    REFERENCES `civilife`.`CHARACTER` (`cha_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
